...
<section class="content" style="padding-right: 0px; background-color: #f7f7f7; width:100%; padding: 0px;">
    ...
    @if($rol==1)               
        <div class="panel panel-default">
            <div class="panel-heading">Seleccione un restaurante</div>
                <div class="panel-body">
                <div class="form-group">
                    <select id="restaurante_selecc" class="form-control">
                ...
                <div class="row" style="padding: 2px; margin: 0px; overflow-y: auto; height: 700px;">
                    <div class="col-md-12" style="padding: 0px;">
                        <div class="box box-info" style="background-color: #fff; padding: 0px;">
                            ...
                            <div class="box-body" >  
                                <form id="fr-cliente-buscar" method="POST">
                                    @csrf
                                    <div class="autocomplete" style="width: 80%;">
                                        <input id="myInput" type="text" name="cliente" placeholder="Buscar cliente">
                                    </div> 
                            ...
                            <form class="form-horizontal" id="fr-franchise" method="post" action="#">   
                                <div class="box-body" >  
                                        ...
                                        @if($rol == 1 || $rol == 2)
                                            <div class="form-group">
                                            <label class="col-md-3 control-label" for="client_id">Restaurante</label>  
                                                <div class="col-md-8">                                       
                                                    <select class="form-control input-md" style="background-color: #e5e5e5;" name="client_id" id="select_client">
                                                        <option value="">--Restaurante--</option> 
                                                        @foreach($clients as $client)
                                                            <option value="{{$client->id}}">{{$client->name}}</option> 
                                                        @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                        <input id="phone" name="phone" style="background-color: #e5e5e5;" type="text"  class="form-control input-md">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group">    
                                        ...
                                        <div class="col-md-8">
                                        <input id="client" name="client" style="background-color: #e5e5e5;" type="text" placeholder="nombre del cliente" class="form-control input-md">
                                        </div> 
                                    </div> 
                                    ...
                                    <div class="form-group">    
                                        ...
                                        <div class="col-md-8">
                                        <input id="address" name="address" style="background-color: #e5e5e5;" type="text" placeholder="direccion del pedido" class="form-control input-md">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group">    
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <textarea name="comment" id="comment" cols="30" rows="10" class="form-control input-md"></textarea>
                                    </div> 
                                    </div> 
